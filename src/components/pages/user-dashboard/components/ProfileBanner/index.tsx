  ...
  return (
    <>
      <div className="w-full h-[154px] relative">
        <div
          className="w-full h-[106px] rounded-2xl flex items-center justify-center bg-cover bg-center"
          style={{
            backgroundImage: backgroundImage,
          }}
        >
          <div
            className="absolute bottom-0 right-6 size-30 rounded-full bg-gray-600 overflow-hidden"
