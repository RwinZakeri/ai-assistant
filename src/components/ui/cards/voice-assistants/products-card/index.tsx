...
import { SubscriptionType } from "@/enums/enum";
...
export const VoiceCard: React.FC<VoiceCardProps> = ({
  ...
  return (
    <Link
      href={`/product/${id}`}
      className="bg-surfacePrimary rounded-2xl flex flex-col gap-5 h-full w-full "
    >
      ...
      <div className="pr-6 pl-6 flex flex-col gap-5 ">
        <div className="flex flex-col ">
          ...
          <div className="flex flex-col gap-2 w-full">
            {/* Category */}
            <div className="text-primary-200  text-xs-demibold   ">
              {category}
            </div>
            ...
            <div className="flex flex-row items-center justify-between">
              ...
              <div className="flex flex-row gap-2 items-center justify-between">
                <div className="text-textTertiary text-md-bold">
                  {SubscriptionType[
                    Number(subscriptionType) as keyof typeof SubscriptionType
                  ] || subscriptionType}
                </div>
            ...
            <div className="flex items-center justify-between h-12 ">
              ...
              <div className="flex gap-2 items-center">
                <div className="text-gray-25 text-xl-bold ">{ratingValue}</div>
                <div>
                  <RaitingiconIcon />
                </div>
              </div>
            ...
            {/* Description */}
            <div
              className="text-textTertiary text-sm-regular overflow-hidden h-18"
